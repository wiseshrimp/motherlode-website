    ...
    return (
      <div className="pillow-talk animate-in">
        ...
        <div className="pillow-text">
          ...
          Pillow Talk is a computer-generated virtual reality experience that covers sex positive topics which are often omitted from traditional sex education curriculum. These topics include, but are not limited to, inclusivity within the vast sexual spectrum, in and out of the bedroom, and counteracting stigmas.
          <div className="s-text">
          ...
          <div className="s-text">
            Pillow Talk is a collaborate project, welcoming any and all ideas encompassing sexuality. We are seeking input, critique, and suggestions as Pillow Talk develops and materializes. Please feel free to contact Motherlode - your voice is indispensible.
          </div>
        </div>
      </div>
    )
